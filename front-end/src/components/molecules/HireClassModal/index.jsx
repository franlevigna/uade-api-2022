...
export const HireClassModal = ({isOpen, handleClose, classData, userData}) => {
  ...
  return classData ?
    <div>
      <Dialog open={isOpen} onClose={handleClose} >
        ...
        <DialogContent>
          <DialogContentText>
            Para contratar esta clase, escribile al profesor con los siguientes datos:
          </DialogContentText>
            <Box 
                id="hireForm"
                component='form'
        ...
        <DialogActions>
          <Button onClick={handleClose} disabled={isHireClassLoading}>Cancelar</Button>
          <Button disabled={isHireClassLoading} type="submit" form="hireForm" variant="contained" >Contratar</Button>
        </DialogActions>
      </Dialog>
    </div>
  : null
